...
public class QrCodeController {
    ...
    public void getCode(String lecNumber , HttpServletResponse response) throws IOException {
        // 设置响应流信息
        ...
        String content = " http://127.0.0.1:8080/admin/signed/?lecNumber="+lecNumber;
        //根据url获取一个二维码图片
